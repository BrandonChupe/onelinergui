#This module primarily acts as a launcher to check for updates before running the rest of the script.
import pickle
import requests
import importlib
...
class UpdateAvailable(Gtk.Dialog):
    ...
    def __init__(self, parent):
        ...
        label = Gtk.Label("There is an update available. Would you like to download it now?")
...
"""Imports the version number from the version file in the github repository."""
...
def import_date():
"""Imports the last day an update was checked from a local pickle file, if none exists it uses a default day."""
    try:
