...
"""send data to clipboard. Requires csv.QUOTE_NONE to prevent duplication of quoting when it passes content into clipboard. """
...
"""Sends a printf/sed friendly version of the normal addhandlers to the clipboard."""
